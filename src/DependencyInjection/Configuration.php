...
class Configuration implements ConfigurationInterface
{
    ...
    public function addNamingSection(ArrayNodeDefinition $rootNode): void
    {
        $rootNode->children()
            ->scalarNode('naming')
            ->info('This value defines the default file naming strategy (Available placeholders: yy/yyyy/m/mm/d/dd/timestamp/uniqid/hash/hash:{LENGTH}:{START}/rule/ext/original_name_with_ext).')
