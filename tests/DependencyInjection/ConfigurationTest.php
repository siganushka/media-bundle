...
class ConfigurationTest extends TestCase
{
    ...
    public function testCustomConfig(): void
    {
        ...
        static::assertSame($processedConfig['channels']['foo']['resize'], ['enabled' => false, 'max_width' => 1000, 'max_height' => 1000]);
        ...
        static::assertSame($processedConfig['channels']['bar']['resize'], ['enabled' => false, 'max_width' => 1000, 'max_height' => 1000]);
        ...
        static::assertEquals($processedConfig['channels']['bar']['resize'], ['enabled' => true, 'max_width' => 1000, 'max_height' => 1000]);
        ...
        $config['channels']['bar']['optimize'] = 50;
        $processedConfig = $processor->processConfiguration(new Configuration(), [$config]);

        static::assertEquals($processedConfig['channels']['bar']['resize'], ['enabled' => true, 'max_width' => 300, 'max_height' => 900]);
        static::assertEquals($processedConfig['channels']['bar']['optimize'], ['enabled' => true, 'quality' => 50]);
    }
