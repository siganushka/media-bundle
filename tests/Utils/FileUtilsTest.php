...
class FileUtilsTest extends TestCase
{
    public function testCreateFromUrl(): void
    {
        try {
            ...
            static::assertSame('GitHub-Mark-ea2971cee799.png', pathinfo($file, \PATHINFO_BASENAME));
            static::assertNotFalse(@getimagesize($file));
    ...
    public function testCreateFromDataUri(): void
    {
        ...
        static::assertSame('foo.jpg', pathinfo($file, \PATHINFO_BASENAME));
        static::assertNotFalse(@getimagesize($file));
    ...
    public function testCreateFromContent(): void
    {
        ...
        static::assertSame('bar.jpg', pathinfo($file, \PATHINFO_BASENAME));
        static::assertNotFalse(@getimagesize($file));
    ...
    {
        static::assertSame('php.jpg', FileUtils::normalizeFilename('php.jpg'));
        static::assertSame('php00000000000000000000000000000.jpg', FileUtils::normalizeFilename('php00000000000000000000000000000000000000000000000000.jpg'));
