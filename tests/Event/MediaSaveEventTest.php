...
class MediaSaveEventTest extends TestCase
{
    ...
    {
        $event = MediaSaveEvent::createFromPath($this->createChannel(), './tests/Fixtures/php.jpg');
        static::assertSame('php.jpg', $event->getFile()->getFilename());
    }

    public function testCreateFromUrl(): void
    {
        try {
            $event = MediaSaveEvent::createFromUrl($this->createChannel(), 'https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png');
    ...
    public function testCreateFromDataUri(): void
    {
        ...
        $event = MediaSaveEvent::createFromDataUri($this->createChannel(), $dataUri, 'foo.jpg');
        static::assertSame('foo.jpg', $event->getFile()->getFilename());
        static::assertNotFalse(@getimagesize($event->getFile()->getPathname()));
    ...
    public function testCreateFromContent(): void
    {
        ...
        $event = MediaSaveEvent::createFromContent($this->createChannel(), $content, 'bar.jpg');
        static::assertSame('bar.jpg', $event->getFile()->getFilename());
        static::assertNotFalse(@getimagesize($event->getFile()->getPathname()));
    ...
    public function testFileNotFoundException(): void
    {
        ...
        $this->expectExceptionMessage('The file "non_existing_file" does not exist');

        MediaSaveEvent::createFromPath($this->createChannel(), 'non_existing_file');
    }
    ...
    public function testDataUriInvalidArgumentException(): void
    {
        ...
        MediaSaveEvent::createFromDataUri($this->createChannel(), 'foo');
    }
