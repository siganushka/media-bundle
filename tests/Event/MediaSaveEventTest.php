...
class MediaSaveEventTest extends TestCase
{
    ...
    {
        $event = MediaSaveEvent::createFromPath($this->channel, './tests/Fixtures/php.jpg');
    ...
    public function testCreateFromContent(): void
    {
        ...
        $event = MediaSaveEvent::createFromContent($this->channel, $content, 'bar.jpg');
    ...
    public function testFileNotFoundException(): void
    {
        ...
        MediaSaveEvent::createFromPath($this->channel, 'non_existing_file');
    }

    public function testBase64InvalidArgumentException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('Invalid file base64 data.');

        MediaSaveEvent::createFromBase64($this->channel, 'foo');
    }
}
